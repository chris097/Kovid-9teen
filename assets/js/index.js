...
//   //  const res =document.querySelector('.menu-burgerA').style.display = 'none'
//    const res1 =document.querySelector('.mobile-navbar .menu-burgerB img').style.display = 'block';
//    const res =document.querySelector('.mobile-navbar .menu-burgerA img').style.display = 'none';
//    console.log(res)
//    console.log(res1)
// })